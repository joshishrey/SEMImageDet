...
#imageArr=['sample 1 aerodyne_m02.tif','sample 1 aerodyne_m04.tif','sample 1 aerodyne_m05.tif','sample 1 aerodyne_m09.tif']
#scaleArr=[5,5,10,5,5,5,5]

#imageArr=['AerodyneSample2_m06.tif','AerodyneSample2_m07.tif','AerodyneSample2_m09.tif','AerodyneSample2_m11.tif']
#scaleArr=[10,5,5,10]

imageArr=['Sample 1 Sample A may 24_m02.tif','Sample 1 Sample A may 24_m03.tif',
          'Sample 1 Sample A may 24_m04.tif','Sample 1 Sample A may 24_m05.tif',
          'Sample 1 Sample A may 24_m06.tif','Sample 1 Sample A may 24_m07.tif',
          'Sample 1 Sample A may 24_m08.tif','Sample 1 Sample A may 24_m09.tif',
          'Sample 1 Sample A may 24_m10.tif','Sample 1 Sample A may 24_m11.tif'
          ]
scaleArr=[5,5,5,5,5,5,5,4,5,10]

solidityTotal=[]
AreaTotal=[]
for ImageCount in range(len(imageArr)):
    image=imageArr[ImageCount]
    scaleLength=scaleArr[ImageCount]
    ...
    PixToNM=scaleLength*1000/(sizeRect[2])
    cv2.imshow('thresh',thresh)



    img = cv2.imread(image, cv2.IMREAD_COLOR)
    sampleDes='Regal_Black_sampleH,_10mins'
    ...
    solidityTotal=np.append(solidityTotal,selectedSolidity)
    AreaTotal=np.append(AreaTotal,equDiameter)
...
hist=ax.hist(AreaTotal[1:], bins='auto')
...
solidityHist=ax2.hist(solidityTotal[1:], bins='auto')
...
df = pd.DataFrame({'areaeqd':AreaTotal, 'solidity':solidityTotal})
df.to_csv(sampleDes+'.csv', index=False)
